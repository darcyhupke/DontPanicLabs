      ...
      do
      {
            ...
            if (userChoiceString=="L" || userChoiceString=="l")
            {
                ...
                using (StreamReader sr = File.OpenText(fileName))
                {
                    ...
                    while ((s = sr.ReadLine()) != null) //read from file. s = each line in file
                    {
                        ...
                        restaurantArray[indexRow,0] = sides[0];
                        restaurantArray[indexRow,1] = sides[1];
        ...
        //  TODO: Else if the option is an S or s then store the array of strings into the text file
            ...
            else if (userChoiceString=="S" || userChoiceString=="s")
            {
                ...
                try
                {
                    ...
                    //string rest = "";
                    //string rate = "";
                    using(StreamWriter fileStr = File.CreateText(fileNameOut))
                    {
                        //for (int indexRow = 0; indexRow < rowSize; indexRow++)
                        //{
                       
                        //        restaurantArray[indexRow,0] = rest;   
                        //        restaurantArray[indexRow,1] = rate;
        ...
        //  TODO: Else if the option is a U or u then update a name in the array (if it's there)
            ...
            else if (userChoiceString=="U" || userChoiceString=="u")
            {
                ...
                //Console.WriteLine("What part would you like to update? Please enter one of the following:");
                //Console.WriteLine("N - to update the restaurant name.");
                //Console.WriteLine("R - to update the rating.");
                //Console.WriteLine("B - to update both values.");
                //bool restInd = Console.ReadLine();
                //string changeNameTo = " ";
                ...
                /*if (restInd = 'N')
                {
                    Console.WriteLine("What would you like to change " + restToUpdate + " to?");
                    changeNameTo = Console.ReadLine();
                }
                    else if (restInd = 'R')                
                    {
                        Console.WriteLine("What would you like to change the rating to?");
                        changeRateTo = Console.ReadLine();
                    }
                        else if (restInd = 'B')
                        {
                            Console.WriteLine("What would you like to change " + restToUpdate + " to?");
                ...
                */
                ...
                for (int indexRow = 0; indexRow < rowSize; indexRow++)
                {
                    ...
                    /*{    
                        ...
                        if (restInd = 'B')
                        {
                            restaurantArray[indexRow,0] = changeNameTo;
                            restaurantArray[indexRow,1] = changeRateTo;  
                        }
                        else 
                            if (restInd = 'N')
