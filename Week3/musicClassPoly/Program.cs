...
namespace musicAPP
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // print each object to test the property gets and the toString
            ...
            // test the MusicGenre inheritance with default constructor
            MusicGenre genre1 = new MusicGenre();        
            Console.WriteLine(genre1);
            MusicGenre genre2 = new MusicGenre("Big Smo","Got Me","YouTube","CRAP");
            Console.WriteLine(genre2);
            genre2.SongMedia = "CD";
            genre2.GGenre = "Country Rap";
            Console.WriteLine(genre2);
/*
            ...
            Console.WriteLine("\n\nMixing music and music genre objects in the array.");
            for (int index = 0; index < musicArray.Length; index++)
            {
                if (!(((musicArray[index]).SongTitle==null)))
                    Console.WriteLine(musicArray[index]);
